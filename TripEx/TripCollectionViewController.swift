...
class TripCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        if let cell = cell{
            ...
            cell.sectionInset = UIEdgeInsets(top: 100, left: 20, bottom: 30, right: 20)
        }
        
        let fetched = PHAsset.fetchAssets(with: nil)
        fetched.enumerateObjects({
            
            (photo: PHAsset, i: Int, bool: UnsafeMutablePointer<ObjCBool>) -> Void in
